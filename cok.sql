...
INSERT INTO `barang` (`kode`, `nm`, `satuan`, `hrg`, `stok`, `deleted`, `biji`) VALUES
	('Asb', 'Asbes Harvlex 150 x 80 x 0.35', 'Lembar', 'IDR 25000.00', 15, 0, 1),
	('Asb10', 'Asbes Harvlex 240 x 105 x 0.4', 'Lembur', 'IDR 68500.00', 5, 0, 1),
	('Asb11', 'Asbes Harvlex 270 x 105x 0.4', 'Lembur', 'IDR 74000.00', 15, 0, 1),
	('Asb12', 'Asbes Harvlex 300 x 105 x 0.4', 'Lembar', 'IDR 82000.00', 15, 0, 1),
	('Asb2', 'Asbes Harvlex 180 x 80 x 0.35', 'Lembar', 'IDR 33500.00', 12, 0, 1),
	('Asb3', 'Asbes Harvlex 210 x 80 x 0.35', 'Lembar', 'IDR 37500.00', 15, 0, 1),
	('Asb4', 'Asbes Harvlex 240 x 80 x 0.35', 'Lembar', 'IDR 42500.00', 15, 0, 1),
	('Asb5', 'Asbes Harvlex 270 x 80 x 0.35', 'Lembar', 'IDR 49500.00', 15, 0, 1),
	('Asb6', 'Asbes Harvlex 300 x 80 x 0.35', 'Lembar', 'IDR 55500.00', 15, 0, 1),
	('Asb7', 'Asbes Harvlex 150 x 105 x 0.4', 'Lembar', 'IDR 44500.00', 15, 0, 1),
	('Asb8', 'Asbes Harvlex 180 x 105 x 0.4', 'Lembar', 'IDR 49000.00', 15, 0, 1),
	('Asb9', 'Asbes Harvlex 210 x 105 x 0.4', 'Lembar', 'IDR 56500.00', 15, 0, 1),
	('BW', 'Benang Woll', 'buah', 'IDR 2000.00', 41, 0, 0),
	('CalO', 'Calsium Onyacarb', 'Sak', 'IDR 30000.00', 17, 0, 1),
	('Ckl', 'Cangkul', 'buah', 'IDR 75000.00', 15, 0, 1),
	('Eng', 'Engsel Pintu', 'buah', 'IDR 5000.00', 100, 0, 1),
	('GerG', 'Gergaji', 'buah', 'IDR 55000.00', 14, 0, 1),
	('Kbl', 'Kabel Merah Hitam', 'Meter', 'IDR 3000.00', 155, 0, 0),
	('kbl hj', 'kabel hijau', 'meter', 'IDR 5000.00', 0, 0, 0),
	('Kbl Pth Bs', 'Kabel Putih Besar', 'Meter', 'IDR 8000.00', 150, 0, 0),
	('Kr', 'Keran', 'buah', 'IDR 5000.00', 17, 0, 1),
	('Mt', 'Meteran', 'Buah', 'IDR 25000.00', 14, 0, 1),
	('Pku', 'Paku 1cm', 'Kg', 'IDR 5000.00', 10, 0, 0),
	('Pl', 'Palu', 'buah', 'IDR 30000.00', 15, 0, 1),
	('Psr', 'Pasir', 'Kg', 'IDR 3000.00', 500, 0, 1),
	('Scp', 'Scop', 'buah', 'IDR 85000.00', 14, 0, 1),
	('SealT', 'Sealtape', 'buah', 'IDR 5000.00', 50, 0, 1),
	('Sel', 'Selang', 'Meter', 'IDR 5000.00', 50, 0, 0),
	('Seng', 'Seng 0.20 mm x 1,8 m x 80 cm', 'Lembar', 'IDR 48000.00', 13, 0, 1),
	('Seng2', 'Seng 0,25 mm x 180 cm', 'Lembar', 'IDR 60500.00', 15, 0, 1),
	('Seng3', 'Seng 0,25 mm x 210 cm', 'Lembur', 'IDR 69500.00', 15, 0, 1),
	('Seng4', 'Seng 0,25 mm x 240 cm', 'Lembur', 'IDR 80000.00', 15, 0, 1),
	('Seng5', 'Seng 0,25 mm x 300 cm', 'Lembur', 'IDR 100000.00', 15, 0, 1),
	('Seng6', 'Seng 0,3 mm x 180 cm', 'Lembur', 'IDR 68000.00', 15, 0, 1),
	('Seng7', 'Seng 0,3 mm x 210 cm', 'Lembar', 'IDR 80000.00', 15, 0, 1),
	('Seng8', 'Seng 0,3 mm x 240 cm', 'Lembar', 'IDR 90000.00', 15, 0, 1),
	('Seng9', 'Seng 0,3 mm x 300 cm', 'Lembar', 'IDR 113000.00', 15, 0, 1),
	('SG', 'Semen Gresik', 'Sak', 'IDR 50000.00', 30, 0, 1),
	('SG ec', 'Semen Gresik Eceran', 'KG', 'IDR 12000.00', 20, 0, 0),
	('SH', 'Semen Holcim', 'Sak', 'IDR 45000.00', 30, 0, 1),
	('SIndo', 'Indocement', 'Sak', 'IDR 40000.00', 16, 0, 1),
	('SPTR', 'Semen Putih Tiga Roda', 'Sak', 'IDR 35000.00', 1, 0, 1),
	('SPTR ec', 'Semen TG Putih Eceran', 'KG', 'IDR 10000.00', 13, 0, 0),
	('Tmp', 'Tampar', 'Meter', 'IDR 2000.00', 50, 0, 0);
